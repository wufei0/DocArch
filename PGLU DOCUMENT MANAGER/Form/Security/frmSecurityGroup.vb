...
Public Class frmSecurityGroup
    ...
    Private Sub frmSecurityGroup_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize

        lstSecurity.Width = Me.Width - 39
        lstSecurity.Height = Me.Height - 236

        btnNew.Top = Me.Height - 63
        btnNew.Left = Me.Width - 268
        btnSave.Top = Me.Height - 63
        btnSave.Left = Me.Width - 187
        btnDelete.Top = Me.Height - 63
        btnDelete.Left = Me.Width - 106

        tabSecurity.Top = lstSecurity.Height + 18
        tabSecurity.Width = Me.Width - 39
        'tabSecurity.Height = Me.Height - 236


        txtFullName.Width = tabSecurity.Width - 105
        txtUserName.Width = tabSecurity.Width - 105
        cboUserGroup.Width = tabSecurity.Width - 105


        txtGroup.Width = tabSecurity.Width - 105
        txtGroupDescription.Width = tabSecurity.Width - 105
    End Sub
End Class