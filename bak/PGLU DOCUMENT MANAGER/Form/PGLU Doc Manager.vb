        ...
        Try
            ...
            If chkOCR.Checked = True Then
                ...
                FbSql = "SELECT   DOCUMENT_ID,DESCRIPTION,C_DOCUMENTFILE.NOTE,C_DOCUMENT.SECURITY_USER,C_DOCUMENT.TRANSDATE " _
                    ...
                    & " ORDER BY DOCUMENT_ID,FILEHISTORY DESC"
            Else
                FbSql = "SELECT   DOCUMENT_ID,DESCRIPTION,C_DOCUMENTFILE.NOTE,C_DOCUMENT.SECURITY_USER,C_DOCUMENT.TRANSDATE " _
                    & "FROM C_DOCUMENT JOIN C_DOCUMENTFILE ON C_DOCUMENT.DOCUMENT_ID = C_DOCUMENTFILE.FK_DOCUMENT_ID JOIN " _
                    & "S_COLUMNGROUP ON C_DOCUMENT.FK_COLUMNGROUP_ID = S_COLUMNGROUP.COLUMNGROUP_ID JOIN L_TAG ON " _
                    ...
                    & "(SELECT FK_COLUMNGROUP_ID FROM L_COLUMNSECURITY WHERE FK_SECURITY_GROUP = '" & Security_Group & "') ORDER BY DOCUMENT_ID,FILEHISTORY DESC"
            End If
            FbCommand.Connection = FbConnection
    ...
    Private Sub lstSearch_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles lstSearch.DoubleClick
        ...
        With frmDocument
            ...
            Try
                ...
                FbSql = "SELECT FILENAME,FILESIZE,SECURITY_USER,TRANSDATE,NOTE,DOCUMENTFILE_ID FROM C_DOCUMENTFILE WHERE FK_DOCUMENT_ID = '" & lstSearch.SelectedItems(0).Text & "' ORDER BY FILEHISTORY DESC"
                FbCommand.CommandText = FbSql
                FBrecordset = FbCommand.ExecuteReader
                FBrecordset.Read()
                ...
                FBrecordset.Close()
                'READ BLOB FILE
                FbSql = "SELECT BLOBFILE FROM C_DOCUMENTFILE WHERE DOCUMENTFILE_ID = '" & .lblDocumentFileID.Text & "' ORDER BY TRANSDATE DESC"
                FbCommand.CommandText = FbSql
                FBrecordset = FbCommand.ExecuteReader
                FBrecordset.Read()
